...
function metodoHerenciaGastosPersonal(){//para la herencia
  layoutMasterV1("1UW_oLYnglQ19B1ZktHqBPkih8xOBNQaRN5uf09WVmAg", "S.Gastos Personales");
...
function metodoEliminarV02(){
    var libroDestino = SpreadsheetApp.openById("1VZ0-VnMHkRb93bwSUaQlro08QdarlVCjR9HPaObcxoA"); //Layout
    var hojaDestino = libroDestino.getSheetByName("Layout");
