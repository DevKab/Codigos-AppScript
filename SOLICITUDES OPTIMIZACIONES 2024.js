...
function obtenerCorreoUsuarioActivo() {
  ...
  var valorCeldaA7 = hoja.getRange("A1").getValue();
...
function macroinsertar() {
  ...
  // Copiar fórmulas en las nuevas filas
  ...
  // Copiar datos desde FORMATO DE SOLICITUDES a LISTA DE SOLICITUDES
  var sourceRange1 = formatoSheet.getRange('A3');
  var sourceRange2 = formatoSheet.getRange('A5');
  var sourceRange25 = formatoSheet.getRange('B5');
  var sourceRange3 = formatoSheet.getRange('C5');
  var sourceRange4 = formatoSheet.getRange('D3');
  var sourceRange5 = formatoSheet.getRange('A7:B7');
  ...
  // Copiar los valores correspondientes
  ...
  // Eliminar validación de datos antes de insertar la fórmula
  var nCell = listaSheet.getRange('N' + lastRow);
  nCell.clearDataValidations(); // Eliminar validación de datos

  // Configuración de las fórmulas dependientes de la columna M
  ...
  // Copiar valores de otras celdas
  ...
  // Validaciones y manejo de celdas específicas
  ...
  // Limpiar contenido después de la inserción
  var fecent = formatoSheet.getRange('B8');
  fecent.clear({ contentsOnly: true, skipFilteredRows: true });

  // Mostrar ventana emergente e invocar otras funciones
...
function correosreapertura() {
  ...
  var subject = "Ticket Optimzacion: " + sheet1.getRange(14, 1).getValue();
...
function CorreoStatic() {
  var ss = SpreadsheetApp.getActiveSpreadsheet()
  var sheet1 = ss.getSheetByName('FORMATO DE SOLICITUDES');
  var emailAddress = "sistemas3@kabzo.org";
  var subject = "Ticket Optimzacion: " + sheet1.getRange(3, 1).getValue();
  var message = "Actividad: " + sheet1.getRange(7, 2).getValue() + "\n" +
    "-----------------------------------------\n" +
    "ID: " + sheet1.getRange(3, 3).getValue() + "\n" +
